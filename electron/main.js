...
function createWindow() {
  ...
  if (isDev) {
    ...
    // In production, load from the exported Next.js static files
...
function createMenu() {
  const template = [
    {
      label: 'Synthweaver Hub',
      submenu: [
        { label: 'About Synthweaver Hub', role: 'about' },
        { type: 'separator' },
        { label: 'Preferences', accelerator: 'CmdOrCtrl+,', click: () => mainWindow?.webContents.send('open-settings') },
        { type: 'separator' },
        { label: 'Hide Synthweaver Hub', role: 'hide' },
    ...
    },
    {
      ...
      submenu: [
        {
          label: 'Documentation',
          click: () => shell.openExternal('https://synthweaver.spell-weaver-studio.com/docs'),
        },
        {
          label: 'GitHub',
